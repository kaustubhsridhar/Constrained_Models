...
writematrix(glucose_matrix, 'Glucose_data_below150.csv');
writematrix(insulin_matrix, 'Insulin_data_below150.csv');
writematrix(meal_values, 'meal_data_below150.csv');